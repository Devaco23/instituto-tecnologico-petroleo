    ...
    const fetchProfile = async () => {
      ...
      if (user) {
        const { data } = await supabase
          ...
          .single();
        if (data) {
          setNombre(data.nombre || "Estudiante");
    ...
    <div style={{ minHeight: "100vh", background: "#F1F5F9", fontFamily: "Inter, sans-serif" }}>
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "52px 28px" }}>
        <div style={{ marginBottom: 40 }}>
          <p style={{ color: "#F97316", fontSize: 11, fontWeight: 600, letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: 8 }}>Aula Virtual</p>
          ...
          <p style={{ color: "#64748b", fontSize: 15, marginTop: 8, lineHeight: 1.6 }}>
            Bienvenido a tu ecosistema de aprendizaje. Aqui encontraras tus rutas de formacion.
          </p>
        </div>
        ...
        <div style={{ background: "white", borderRadius: 24, border: "1px solid rgba(0,0,0,0.06)", padding: "64px 32px", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
          <div style={{ background: "#fff7ed", width: 80, height: 80, borderRadius: 22, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 24 }}>
            <BookOpen size={36} color="#F97316" />
          </div>
          <h2 style={{ color: "#0F172A", fontSize: 24, fontWeight: 700, letterSpacing: "-0.5px", marginBottom: 12 }}>
            Tu aula esta lista
          </h2>
          <p style={{ color: "#94a3b8", fontSize: 15, maxWidth: 360, lineHeight: 1.6, margin: 0 }}>
            Aun no tienes cursos asignados. El administrador te inscribira pronto.
          </p>
          <div style={{ width: "100%", height: 1, background: "rgba(0,0,0,0.06)", margin: "36px 0" }} />
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
            <span style={{ background: "#fff7ed", color: "#F97316", fontSize: 12, fontWeight: 500, padding: "6px 16px", borderRadius: 980 }}>Petroleos</span>
            <span style={{ background: "#eff6ff", color: "#3b82f6", fontSize: 12, fontWeight: 500, padding: "6px 16px", borderRadius: 980 }}>Seguridad Industrial</span>
            <span style={{ background: "#ecfdf5", color: "#10b981", fontSize: 12, fontWeight: 500, padding: "6px 16px", borderRadius: 980 }}>Marketing</span>
          </div>
        </div>
      </main>
